...
Param(
  ...
  [string] $TemplateFile = '..\Templates\VM-ScaleSet-Cluster\azuredeploy.json',
  [string] $TemplateParametersFile = '..\Templates\VM-ScaleSet-Cluster\azuredeploy.parameter.json',
